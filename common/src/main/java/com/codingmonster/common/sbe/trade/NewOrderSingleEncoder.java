...
public final class NewOrderSingleEncoder
{
    ...
    public NewOrderSingleEncoder putSymbol(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
    ...
    public NewOrderSingleEncoder putSenderCompID(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public NewOrderSingleEncoder putSenderCompID(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
