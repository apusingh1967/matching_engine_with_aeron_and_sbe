...
public final class TradeCaptureReportEncoder
{
    ...
    public TradeCaptureReportEncoder putSymbol(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
    ...
    public TradeCaptureReportEncoder putSymbol(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
